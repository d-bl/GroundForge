...
Batch execution is faster, doesn't make a fuss if it takes a while and allows as many recursion step as your system can handle. Downside: it requires a few hoops to jump through.
