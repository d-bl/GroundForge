...
function load() {
    ...
    if (typeof urlQuery === "undefined" || urlQuery.trim() == "")
        // pinwheel
        linkdefs.innerHTML = "b4,a1,lo,ri;d4,a1,lo,li;b2,a3,lo,ri;d2,a3,lo,li;a1,b1,lo,li;b4,b1,ro,ri;b1,b2,lo,li;c1,b2,lo,ri;a3,b4,lo,li;c3,b4,lo,ri;b1,c1,ro,li;d4,c1,ro,ri;b2,c3,ro,li;d3,c3,lo,ri;a1,d2,ro,ri;c1,d2,ro,li;a3,d3,ro,ri;d2,d3,ro,li;c3,d4,ro,li;d3,d4,ro,ri"
    else
        linkdefs.innerHTML = TopoLink.asString(linkdefs.innerHTML)
    showDiagram(linkdefs.innerHTML)
}
...
//            var deltas = rand(20,2) // TODO infinite nullspace(array2mat(data))
