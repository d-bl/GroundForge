...
<input type="number" name="stitchesRequired" id="stitchesRequired" min="1" max="25" value="1" size="5" onchange="GF_Random.genVal(this)" > 
The number of stitches required. Minimal 1, maximal 25.    

<input type="number" name="maxCrosses" id="maxCrosses" min="1" max="5" value="3" size="5" onchange="GF_Random.genVal(this)" > 
The maximal number of crosses in a stitch, between 1 and 5.    
The generated stitch has at least one cross.     

<input type="number" name="maxTwistsBetweenCrosses" id="maxTwistsBetweenCrosses" min="1" max="5" value="1" size="5" onchange="GF_Random.genVal(this)" >
...
<input type="number" name="maxTwistsBefore" id="maxTwistsBefore" min="0" max="5" value="0" size="5" onchange="GF_Random.genVal(this)" >
...
<input type="number" name="maxTwistsAfter" id="maxTwistsAfter" min="0" max="5" value="2" size="5" onchange="GF_Random.genVal(this)" >
