...
* Affinity Designer (💰, Mac, iPad and Windows)  
  ...
  Hint: some patterns may have more variants than fit into the visible area, zoom out a little, select everything and move the patterns around to find the one you want to use.
