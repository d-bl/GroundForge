...
Once this lace ground has been captured in GroundForge, it is natural to play with the snowflake variations. Below are four main variations showing the prototype diagram (top row) and corresponding thread diagram (bottom row).
...
* 0:00 start with the help page (a slightly older version was recorded)
* 0:00 follow "_with_"
