...
/**
  ...
  * ::^ ^::
  * }}}
  * Each `o` represent either an unused node or a stitch with two incoming pairs (or links) and two outgoing pairs.
  * The row and col of these cells define the target of the links,
  ...
  *                    The outer two rows are placeholders for sources and targets of the fringes.
  */
