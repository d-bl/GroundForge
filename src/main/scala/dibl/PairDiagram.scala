...
object PairDiagram {
  ...
  /** Creates nodes for a pair diagram
    *
    * @return properties per node as in https://github.com/d-bl/TesseLaceD/blob/gh-pages/sample.js
    */
  ...
  /** Creates links for a pair diagram
    ...
    * @return properties per link as in https://github.com/d-bl/TesseLaceD/blob/gh-pages/sample.js
    */
